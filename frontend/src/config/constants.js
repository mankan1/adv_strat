// API Configuration
export const API_BASE_URL = process.env.API_BASE_URL || 'http://advstrat-production.up.railway.app:8080'; //https://advstrat-production.up.railway.app
export const SOCKET_URL = process.env.SOCKET_URL || 'ws://advstrat-production.up.railway.app:8080';

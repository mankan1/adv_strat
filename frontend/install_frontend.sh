...
echo ""
echo "🌐 Web version will open at: https://advstrat-production.up.railway.app:19006"
echo ""
echo "⚠️  IMPORTANT: Make sure the backend is running at https://advstrat-production.up.railway.app:5000"
